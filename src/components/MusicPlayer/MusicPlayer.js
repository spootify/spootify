...
class MusicPlayer extends Component {
	...
	currentlyPlaying() {
		this.setState({
			...
			currentlyPlayingSong      : (this.props.player.currentlyPlaying.item) ?
										this.props.player.currentlyPlaying.item.name : '',
			currentlyPlayingAlbum     : (this.props.player.currentlyPlaying.item) ?
										this.props.player.currentlyPlaying.item.album.name : '',
			currentlyPlayingAlbumCover: (this.props.player.currentlyPlaying.item) ?
										this.props.player.currentlyPlaying.item.album.images[1].url : '',
			currentlyPlayingArtist    : (this.props.player.currentlyPlaying.item) ?
										this.props.player.currentlyPlaying.item.artists[0].name : '',
			progress_ms               : (this.props.player.currentlyPlaying.progress_ms) ?
										this.props.player.currentlyPlaying.progress_ms : '',
			duration_ms               : (this.props.player.currentlyPlaying.item) ?
										this.props.player.currentlyPlaying.item.duration_ms : '',
			track_uri                 : (this.props.player.currentlyPlaying.item) ?
										this.props.player.currentlyPlaying.item.uri : '',
			album_uri                 : (this.props.player.currentlyPlaying.item) ?
										this.props.player.currentlyPlaying.item.album.uri : ''
		})
	}
