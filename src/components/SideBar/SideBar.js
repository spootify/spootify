        ...
        return (
            <div className='sideBar'>
                <div>
                    ...
                    <div>
                        <h3>YOUR LIBRARY</h3>
                        <Link to="/dashboard/recent"><p>Recently Played</p></Link>
                        <Link to="/dashboard/songs"><p>Songs</p></Link>
                        <Link to="/dashboard/albums"><p>Albums</p></Link>
                        <Link to="/dashboard/artists"><p>Artists</p></Link>
                    </div>
                    <div>
                        <h3>PLAYLIST</h3>
